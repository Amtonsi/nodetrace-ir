...
- AVZ, его executable и базы не входят в Apache-2.0 source distribution и регулируются отдельными условиями правообладателя.
...
Архитектура и модель доказательств описаны в [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) и [docs/EVIDENCE_MODEL.md](docs/EVIDENCE_MODEL.md). Правила участия — в [CONTRIBUTING.md](CONTRIBUTING.md). Лицензия NodeTrace IR — [Apache License 2.0](LICENSE); сведения о сторонних компонентах — в [NOTICE](NOTICE).
