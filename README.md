...
<p align="center">
  <img src="docs/images/hero.png" alt="NodeTrace IR — цепочка источник, файл и воздействие" width="960">
</p>
<p align="center"><sub>Цепочка расследования: источник попадания → подозрительный файл → затронутые процессы, файлы, реестр и сеть.</sub></p>
